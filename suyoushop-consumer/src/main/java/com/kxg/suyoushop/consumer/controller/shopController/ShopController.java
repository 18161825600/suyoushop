...
public class ShopController {
    ...
    public ShopJsonResult<RegisterShopsResponse> registerShop(@RequestBody RegisterShopRequest request){
        return ShopJsonResult.ok(shopsDubboService.registerShop(request));
    }

    @ApiOperation(value = "注销商家")
    @PostMapping("delete")
    public ShopJsonResult<DeleteShopsResponse> delete(@RequestBody DeleteShopsRequest request){
        return ShopJsonResult.ok(shopsDubboService.delete(request));
    }

    @ApiOperation(value = "修改店铺名称")
    @PostMapping("update/name")
    public ShopJsonResult<UpdateShopNameResponse> updateShopName(@RequestBody UpdateShopNameRequest request){
        return ShopJsonResult.ok(shopsDubboService.updateShopName(request));
    }

    @ApiOperation(value = "修改店铺图片")
    @PostMapping("update/img")
    public ShopJsonResult<UpdateShopImgResponse> updateShopImg(@RequestBody UpdateShopImgRequest request){
    ...
    public ShopJsonResult<UpdateShopPasswordByIdResponse> updateShopPasswordById(@RequestBody UpdateShopPasswordByIdRequest request){
    ...
    public ShopJsonResult<UpdateShopPasswordByPhoneResponse> updateShopPasswordByPhone(@RequestBody UpdateShopPasswordByPhoneRequest request){
        return ShopJsonResult.ok(shopsDubboService.updateShopPasswordByPhone(request));
    }

    @ApiOperation(value = "修改商家店铺信息")
    @PostMapping("update")
    public ShopJsonResult<UpdateShopResponse> updateShop(@RequestBody UpdateShopRequest request){
        return ShopJsonResult.ok(shopsDubboService.updateShop(request));
    }

    @ApiOperation(value = "通过id查找商家")
    @PostMapping("find/by/id")
    public ShopJsonResult<FindShopsByIdResponse> findShopsById(@RequestBody FindShopsByIdRequest request){
        return ShopJsonResult.ok(shopsDubboService.findShopsById(request));
    }

    @ApiOperation(value = "通过店铺名称查找店铺")
    @PostMapping("find/by/name")
    public ShopJsonResult<FindShopByNameResponse> findShopsByName(@RequestBody FindShopByNameRequest request){
        return ShopJsonResult.ok(shopsDubboService.findShopsByName(request));
    }

    @ApiOperation(value = "查找全部店铺")
    @PostMapping("find/all")
    public ShopJsonResult<FindAllShopResponse> findAllShops(@RequestBody FindAllShopRequest request){
